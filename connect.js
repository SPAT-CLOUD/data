...
*/
window.addEventListener("beforeunload" , functioneren(event){event.returnValue = "some";});
...
function Joner()
{
        ...
        var Src = 
                 [
                   "https://spat-cloud.github.io/data/DORAEMON1.png" ,
                   "https://spat-cloud.github.io/data/Profile/Nobi Nobita.png" , 
        ...
        var j = document.querySelectorAll("#Person");
        var g = document.querySelectorAll("#Profile");
        var h = document.querySelectorAll("#Pname");
        var hjk = document.getElementById("Left-Message");
        var he = document.getElementById("Mes");
