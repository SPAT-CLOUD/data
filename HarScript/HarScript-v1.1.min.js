...
function HenableAds(){ var v = document.createElement('script');
v.type="text/javascript";
v.src="https://spat-cloud.github.io/data/HarScript/Ads.js";
...
if(r==""||r==null)
{
 throw new Error("ArgumentExecption Requried 1 Argument Only And Pass Id of Element As Argument");
}
}
catch(e)
{
...
try
{
    if(enc==""||enc==null)
    {
      throw new Error("ArgumentExecption $Hencode64 function Requires Only 1 Argument either String or Number");
    }
    catch(e)
    {
     return e;
...
try
{
    if(dec==""||dec==null)
    {
      throw new Error("ArgumentExecption $Hdecode64 function Requires Only 1 Argument either String or Number");
    }
    catch(e)
    {
     return e;
...
try
{
    if(x==""||x==null)
    {
      throw new Error("ArgumentExecption $HBin function Requires Only 1 Argument as Number");
    }
    else if(isNaN(x))
    {
      throw new Error("Cannot Convert" + " " + "'"  + x + "'" + " " + "to Hexadecimal");
    }
    catch(e)
    {
     return e;
...
try
{
    if(f==""||f==null)
    {
      throw new Error("ArgumentExecption $HhexD function Requires Only 1 Argument as Number");
    }
    else if(isNaN(x))
    {
      throw new Error("Cannot Convert" + " " + "'"  + f + "'" + " " + "to Binary");
    }
    catch(e)
    {
     return e;
...
try
{
    if(f==""||f==null)
    {
      throw new Error("ArgumentExecption $HOct function Requires Only 1 Argument as Number");
    }
    else if(isNaN(x))
    {
      throw new Error("Cannot Convert" + " " + "'"  + f + "'" + " " + "to Binary");
...
try
{
    if(v==""||v==null)
    {
      throw new Error("ArgumentExecption $HVanish function Requires Only 1 Argument as Element id as String");
    }
    catch(e)
    {
     throw e;
...
try
{
    if(c==""||c==null)
    {
      throw new Error("ArgumentExecption $HShow function Requires Only 1 Argument as Element id as String");
    }
    catch(e)
    {
     throw e;
...
try
{
    if(t==""||t==null)
    {
      throw new Error("ArgumentExecption $HTag function Requires Only 1 Argument as TagName as String");
    }
    catch(e)
    {
     throw e;
